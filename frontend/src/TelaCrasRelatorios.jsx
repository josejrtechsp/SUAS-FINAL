...
import RmaMetasPanel from "./RmaMetasPanel.jsx";
...
const cruzRows = useMemo(() => {
  ...
  async function downloadProntuarioFamiliaCsv() {
    ...
    return (
      ...
      <RmaMetasPanel apiBase={apiBase} apiFetch={apiFetch} isActive={(typeof viewKey !== "undefined") ? (viewKey === "metas") : true} />
...
<button className="btn btn-secundario" type="button" onClick={() => __downloadRmaCsv(apiBase, apiFetch, (typeof mesAno !== "undefined" ? mesAno : ""), (typeof unidadeId !== "undefined" ? unidadeId : ""))}>
              RMA (CSV do mês)
            </button>
            <button className="btn btn-secundario" type="button" onClick={() => __downloadProntuarioPessoaCsv(apiBase, apiFetch)}>
              Prontuário Pessoa (CSV)
            </button>
            <button className="btn btn-secundario" type="button" onClick={() => __downloadProntuarioFamiliaCsv(apiBase, apiFetch)}>
