...
import PesProntuarioPanel from "./PesProntuarioPanel.jsx";
...
useEffect(() => { loadPessoas(); }, []); // eslint-disable-line
  ...
  return (
    <div className="layout-1col">
      <PesProntuarioPanel apiBase={apiBase} apiFetch={apiFetch} pessoaId={pessoaSel} familiaId={data?.familia?.id || null} />
