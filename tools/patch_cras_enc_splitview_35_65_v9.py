#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""CRAS Encaminhamentos Split View 35/65 — Patch V9
Hotfix do V8: corrigir strings com aspas.
Mantém a estratégia do V8.
"""
...
marker = "CRAS_ENC_SPLITVIEW_35_65_V9"
if any(marker in l for l in lines):
    print("OK: SplitView já aplicado (V9).")
    raise SystemExit(0)
...
print("✅ OK: SplitView V9 aplicado em", target)
print("Backup:", bak)

# 5) CSS
if css_path.exists():
    css = css_path.read_text(encoding="utf-8", errors="ignore")
    css_marker = "/* CRAS_ENC_SPLITVIEW_35_65_CSS_V9 */"
    if css_marker not in css:
        ...
        css_add = '''
\n\n/* CRAS_ENC_SPLITVIEW_35_65_CSS_V9 */
...
'''
        ...
        print("✅ CSS SplitView V9 adicionado em", css_path)
