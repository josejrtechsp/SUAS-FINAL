#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""CRAS Encaminhamentos Split View 35/65 - Patch V10 (char-level parser)
- Finds the root <div ...cras-flow-mini...> and its matching </div> by counting <div></div> tags,
  ignoring occurrences inside strings and comments.
- Moves the <EncaminhamentosSuas ...> block (multiline, with '=>', etc.) to the right column.
- Puts all remaining root inner content into the left column.
...
MARKER = "CRAS_ENC_SPLITVIEW_35_65_V10"
...
def append_css():
    ...
    css_marker = "/* CRAS_ENC_SPLITVIEW_35_65_CSS_V10 */"
    ...
    css_add = """\n\n/* CRAS_ENC_SPLITVIEW_35_65_CSS_V10 */
...
def main():
    ...
    if root_close_start == -1:
        raise SystemExit("Could not find matching root </div>.")
    ...
    print("OK: SplitView V10 applied:", target)
    print("Backup:", bak)
